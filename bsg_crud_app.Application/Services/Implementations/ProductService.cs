...
namespace bsg_crud_app.Application.Services.Implementations;
...
public class ProductService : IProductService
{
    ...
    /// <returns></returns>
    public async Task<ObjectResponse> Create(CreateProductRequestDto createProductRequestDto)
    {
        ...
        if (!validationResult.IsValid)
        {
            ...
            var response = new ObjectResponse(
                ...
                new GenericResponse<ProductResponseDto>(
                    HttpStatusCode.BadRequest,
                    errors: errors
                    )
                );
